    ...
    T2: GuildCommanderRepository + Send + Sync,
{
    ...
    pub async fn adventurer_refresh_token(&self, refresh_token: String) -> Result<i32> {
        unimplemented!()
    }
    ...
    pub async fn guild_commander_refresh_token(&self, refresh_token: String) -> Result<i32> {
        unimplemented!()
    }
}
